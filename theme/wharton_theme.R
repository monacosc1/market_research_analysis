...
logo <- image_read("~/python_scripts/git/market_research_jan_2022/theme/main-wharton-logo.png")
logo_dark <- image_read("~/python_scripts/git/market_research_jan_2022/theme/main-wharton-logo.png")
